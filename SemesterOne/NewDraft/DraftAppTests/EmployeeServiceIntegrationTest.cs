...
public class EmployeeServiceTests
{
    ...
    public void WorkstationRegistrationAddsRegistration()
    {
        ...
        // Register the IDataService interface with the container
        builder.RegisterType<DataService>().SingleInstance();

        // Register the EmployeeService class with the container and inject the IDataService dependency
        builder.RegisterType<EmployeeService>().As<IEmployeeService>().WithParameter(
            new TypedParameter(typeof(IDataService), new DataService(employeeList, workstationList, checkinList)));

        // Build the container
        var container = builder.Build();

        // Resolve the IEmployeeService instance from the container
        ...
        // Assert
        List<Checkin> Checkins = .GetEmployeesCurrentlyCheckedIn();
